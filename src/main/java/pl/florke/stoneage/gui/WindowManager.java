...
public class WindowManager {
    ...
    public Window getWindow(TileState machineBlockState) {
    ...
    public void cacheMachine(TileState machineState, Window window) {
        cachedMachines.put(machineState, window);
    }
